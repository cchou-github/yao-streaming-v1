...
public enum StreamStatus {
	 ...
	 * reserve a channel stays {@code PENDING} forever (see
	 * {@code LiveStreamingService#goLive}'s own javadoc) - harmless and
	 * inert, not a reason to ever block a user from trying again.
	 */
